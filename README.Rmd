...
As you may have the question, why not use 0.5 as cut point? I did try with 0.5 as cut point with very low accuracy and sensitivity (see below). Thus we will keep use optimal cut point for later process. 
...
```{r}
 ...
 confusionMatrix(as.factor(boost_pred_class_ins05),
                 test_subset$new_response, positive = 1)
